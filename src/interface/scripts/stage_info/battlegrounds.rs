...
mod tests {
    ...
    fn test_dojo_with_different_bhp() {
        ...
        assert_eq!(talent_tournament.enemies[0].base_hp, 100);
        ...
        assert_eq!(
            ...
            *1 [[Othom]] spawns after 156.67 seconds<sup>4,700f</sup>.\n\
            ...
            *1 [[Mr. Puffington]] (100%) spawns after 106.67 seconds<sup>3,200f</sup>.\n\
            *1 [[Scissoroo]] (1,200%) spawns after 100 seconds<sup>3,000f</sup>.\n\
            *1 [[Great Angel Chibinel]] spawns after 100 seconds<sup>3,000f</sup>.\n\
            ...
            *1 [[Crustaceous Scissorex]] (100%) spawns after 80 seconds<sup>2,400f</sup>.\n\
            ...
            *3 [[Sir Rel]]s (100%) spawn after 50 seconds<sup>1,500f</sup>, delay 6.67~10 seconds<sup>200f~300f</sup>.\n\
            ...
            *When the base takes 50,000 damage:\n\
            **1 [[Othom]] spawns.\n\
            *When the base takes 100,000 damage:\n\
            ...
            *When the base takes 210,000 damage:\n\
            **2 [[Sir Rel]]s (100%) spawn, delay 6.67~10 seconds<sup>200f~300f</sup>.\n\
            *When the base takes 400,000 damage:\n\
            **1 [[Bun Bun Symbiote]] (200%) spawns as the boss.\n\
            *When the base takes 700,000 damage:\n\
            **4 [[Gabriel]]s (300%) spawn, delay 6.67~10 seconds<sup>200f~300f</sup>.\n\
            *When the base takes 710,000 damage:\n\
            ...
            *When the base takes 1,700,000 damage:\n\
            **1 [[Great Angel Chibinel]] spawns as the boss.\n\
            **1 [[Mr. Puffington]] (100%) spawns.\n\
            *When the base takes 2,000,000 damage:\n\
            **1 [[Scissoroo]] (1,400%) spawns.\n\
            *When the base takes 2,100,000 damage:\n\
            ...
            *When the base takes 3,500,000 damage:\n\
            **1 [[St. Dober]] (150%) spawns as the boss.\n\
            **1 [[Great Angel Chibinel]] spawns.\n\
            *When the base takes 4,000,000 damage:\n\
            **1 [[Bun Bun Symbiote]] (500%) spawns.\n\
            *When the base takes 4,100,000 damage:\n\
            **8 [[Gabriel]]s (500%) spawn, delay 10~13.33 seconds<sup>300f~400f</sup>.\n\
            *When the base takes 5,000,000 damage:\n\
