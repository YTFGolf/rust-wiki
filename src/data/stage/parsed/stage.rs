...
impl Stage {
    ...
    pub fn new_current(selector: &str) -> Option<Self> {
        use crate::config2::config2::DEFAULT_CONFIG;
...
mod tests {
    use super::*;
    use crate::{config2::config2::DEFAULT_CONFIG, data::stage::get_stages};
    ...
    #[ignore]
    fn get_all() {
        for stage in get_stages(&DEFAULT_CONFIG.version.current_version()) {
